...
export const Route = createFileRoute("/programs")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://beacon-indica.lovable.app/programs" },
    ],
    links: [{ rel: "canonical", href: "https://beacon-indica.lovable.app/programs" }],
    scripts: [
      {
    ...
    <>
      <section className="bg-surface-container-low py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <span className="font-mono-label text-accent">The Ecosystem</span>
          ...
          >
            ...
            <div className="grid md:grid-cols-12 gap-8">
              <div className="md:col-span-4">
                ...
                <h2 data-animate="fade-up" className="text-[36px] md:text-[44px] font-bold mt-4 tracking-tight">{p.title}</h2>
              ...
              <div className="md:col-span-8">
                ...
                {p.id === "genesis" && (
                  <div className="inline-flex items-center gap-2 bg-accent/10 border border-accent/20 rounded-full px-4 py-1.5 mt-4">
                ...
                {p.id === "genesis" && (
                  <div className="mt-10 space-y-12">
                    {/* Stats */}
                    <div data-animate="stagger" className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {genesisStats.map(([n, l]) => (
                        <div key={l} className="bg-surface-container-low rounded-lg p-4 text-center border border-outline-variant">
                    ...
                    <div>
                      ...
                      <ul data-animate="stagger" className="grid sm:grid-cols-2 gap-4 mt-4">
                        {genesisOutcomes.map(([t, d]) => (
                    ...
                    <div>
                      ...
                      <ol data-animate="stagger" className="mt-4 space-y-4 border-l-2 border-accent/30 pl-6">
                        {curriculum.map((c) => (
                    ...
                    <div>
                      ...
                      <ul className="mt-3 space-y-2">
                        {whoFor.map((w) => (
                          <li key={w} className="flex items-start gap-2 text-on-surface-variant">
                ...
                {p.id === "fellowship" && (
                  <div className="mt-10 space-y-10">
                    <div data-animate="scale-up" className="bg-accent-tint border border-accent/30 rounded-xl p-6 text-center">
                    ...
                    <div data-animate="stagger" className="grid sm:grid-cols-2 gap-4">
                      {fellowshipPillars.map(([Icon, t, d]) => (
                        <div key={t} className="bg-surface-container-low border border-outline-variant rounded-lg p-5">
                ...
                <Link
                  to="/contact"
                  className={`inline-flex items-center gap-2 mt-10 font-bold ${p.dark ? "text-accent" : "text-primary"}`}
                >
                  Apply Now
      ...
      <section className="bg-surface-container-low py-20">
        <div className="max-w-[1200px] mx-auto px-6 md:px-10">
          <div className="text-center">
            <span data-animate="fade-up" className="font-mono-label text-accent">Get Involved</span>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-12">
            <div className="bg-card border border-outline-variant rounded-xl p-8">
              ...
              <Link to="/contact" className="inline-flex items-center gap-2 mt-6 font-bold text-accent">
